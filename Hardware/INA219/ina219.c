...
uint16_t INA219_ReadDataForRegister_16Bits(INA219_t *ina219, uint8_t registerAddress)
{
    ...
    HAL_I2C_Mem_Read(ina219->ina219_i2c, (INA219_ADDRESS << 1) | 0x01, registerAddress, 1, Value, 2, 0x1000);
...
void INA219_WriteDataToRegister_16Bits(INA219_t *ina219, uint8_t registerAddress, uint16_t Value)
{
    ...
    HAL_I2C_Mem_Write(ina219->ina219_i2c, (INA219_ADDRESS << 1), registerAddress, 1, (uint8_t *)regAddr, 2, 0x1000);
}
...
{
    uint16_t configInfo = INA219_CONFIG_VOLTAGE_RANGE_16V | NA219_CONFIG_GAIN_4_160MV |
                          INA219_CONFIG_BADCRES_12BIT_128S_69MS | INA219_CONFIG_SADCRES_12BIT_128S_69MS |
                          INA219_CONFIG_MODE_SANDBVOLT_CONTINUOUS;

    // Current_LSB = Maximum Expected Current / 2^15 = (160 / 100) / 2^15 = 0.00005
    // Cal = 0.04096 / (Current_LSB / R) = 0.04096 / (0.00005A * 0.1R) = 8192
    // Calibration Register = 8192
    ina219_calibrationValue = 8192;

    // 1mA = Current_LSB * bits = 50uA * 20bit (5 bit/mA)
...
uint8_t INA219_Init(INA219_t *ina219, I2C_HandleTypeDef *i2c, uint8_t Address)
{
    ...
    uint8_t ina219_isReady = HAL_I2C_IsDeviceReady(i2c, (Address << 1) | 0x01, 3, 0x1000);
